...
``$ cd <cloned-folder>`` 
``$ git remote add upstream https:/SC-ECE/github.com//WEB-PROJECT.git ``
******
...
<table>
	<tr>
		<td>
			<a href="https://github.com/SC-ECE/WEB-PROJECT/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=SC-ECE/WEB-PROJECT" />
</a>
		</td>
	</tr>
</table>
